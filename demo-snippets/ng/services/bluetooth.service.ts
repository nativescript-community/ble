...
export class BluetoothService {
    ...
    scanForPeripherals(serviceUUIDs?: string[], seconds?: number): boolean {
        ...
        this.scanSubscription = this.startScan(serviceUUIDs, seconds)
            .pipe(takeWhile((peripheral: IPeripheral, idx: number): boolean => peripheral.UUID !== BluetoothService.SIGNAL_STOP_PERIPHERAL().UUID))
            .subscribe(
    ...
    write(characteristic: ICharacteristic, value: any) {
        // According to source code at https://github.com/nativescript-community/ble,
